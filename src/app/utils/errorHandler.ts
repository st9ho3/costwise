...
import { AuthenticationError, ConflictError, DatabaseError, ForbiddenError, NotFoundError, ValidationError } from "./errors"
...
export const errorHandler = (err: unknown) => {
    ...
    return sendError({message: "Something went wrong. Please try again."}, 500)
    }
