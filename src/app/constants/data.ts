...
export const recipesColumns: Column[] = [
  ...
  },
  {
    ...
    accessor: "tax",
    className:
      "hidden md:table-cell md:w-1.5/10 text-gray-500 text-sm text-left pl-4",
  },
  {
    header: "Price",
  ...
  },
  {
    ...
    accessor: "totalCost",
    className:
      "hidden md:table-cell text-gray-500 text-sm md:w-1.5/10 text-center md:text-left md:pl-4",
  },
  {
    header: "Actions",
    accessor: "actions",
...
export const ingredientColumns: Column[] = [
  ...
  },
  {
    ...
    accessor: "unitPrice",
    className:
      "text-gray-500 w-1/6 md:w-2/10 text-sm text-center md: text-start pl-4",
  },
  {
    header: "Usage",
    accessor: "usage",
    className:
      "hidden md:table-cell md:w-2/10 text-gray-500 text-sm text-center md: text-start pl-4",
  },
  {
    header: "Category",
    accessor: "category",
  ...
  },
  {
    ...
    accessor: "actions",
    className:
      "text-gray-500 w-2/6 md:w-2/10 text-sm text-center md:text-start pl-4",
  },
];
