...
export type IngredientCategoryName = z.infer<
  typeof IngredientCategoryNameSchema
>;
...
export const RecipeCategorySchema = z.union(
  [z.literal("starter"), z.literal("main"), z.literal("dessert")],
  {
    errorMap: () => ({
...
export type IngredientSuppliers = Ingredient["suppliers"];
...
export const SupplierSchema = z.object({
  ...
  // Logistics
  deliveryTime: DeliveryTimeSchema.optional().nullable(),
  // Status & Metadata
  isActive: z.boolean(),
